...
function preload() {
  ...
  // starImg = loadImage("./src1/star.png");
...
// bgmButton=loadImage("./src1/bgmImg.png");
  ...
  rex3 = loadAnimation("./src/t12.png");
...
function setup() {
  ...
  sprite1.addAnimation("rex3", rex3);
  sprite1.scale = 0.4;
...
function draw() {
  ...
  if(bCount%2==0){
    background(colour2);
    textColour="black";
    // cloudGrp.visible=false;
    // c1.visible=false;
  }else{
    // alert("bcount is "+bCount);
    background(colour1);
    textColour="white";
    // cloudGrp.visible=true;
  }
...
function createCloud() {
  // Check if the background color is colour1
  if (bCount % 2 === 0) {
    if (frameCount % 150 === 0) {
